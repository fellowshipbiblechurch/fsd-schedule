...
function createDanceSchedule() {
	...
	var friday = [
		...
		new danceClass("Friday", "A", "Advanced Ballet & Variations", "/ballet", 16, 0, 18, 30),
		new danceClass("Friday", "B"),
		new danceClass("Friday", "C", "Intro to Hip-Hop", "/hip-hop", 16, 30, 17, 30),
		new danceClass("Friday", "C", "Hip-Hop I", "/hip-hop", 17, 30, 18, 30)
	];
